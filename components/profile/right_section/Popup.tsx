...
const Popup = ({date,setPopup}:{date:string,setPopup:React.Dispatch<React.SetStateAction<string>>}) => {
    ...
    return (
    <div className="fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[90%] h-[90%] flex flex-col items-center bg-white border-2 shadow-2xl shadow-black z-10 rounded-xl overflow-y-auto py-10">
