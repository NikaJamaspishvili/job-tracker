  ...
  return (
    <div className=" fixed top-0 left-0 w-full bg-blue-500 px-5 py-2 z-10">
      <div className="flex items-center justify-between max-w-[1200px] w-[95%] mx-auto">
        ...
        <section className="flex gap-7 [&>a]:cursor-pointer [&>a]:font-manrope font-semibold text-white [&>a]:relative [&>a]:after:content-[''] [&>a]:after:block [&>a]:after:h-[2px] [&>a]:after:bg-white [&>a]:after:w-0 [&>a]:after:transition-all [&>a]:after:duration-300 [&>a]:hover:after:w-full [&>a]:after:absolute [&>a]:after:left-0 [&>a]:after:bottom-[-2px]">
